    ...
    public partial class AddUsers : System.Web.UI.Page
    {
        ...
        protected void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            protected void InsertButton_Click(object sender, EventArgs e)
            {
                ...
                SqlCommand Case = new SqlCommand("Insert into Disciple (FName, Surname, Date_Of_Birth, Cell_Number, Email, Gender, Str_Name, Str_Num, Str_Suburb, Str_Town, DisciplerSurname, DisciplerName, Discipler_ID) values " +
                                                                       "(@FName, @Surname, @Date_Of_Birth, @Cell_Number, @Email, @Gender, @Str_Name, @Str_Num, @Str_Suburb, @Str_Town, @DisciplerSurname, @DisciplerName, @Discipler_ID)", conCase);
                ...
                Response.Redirect("~/Admin/successful.aspx");
